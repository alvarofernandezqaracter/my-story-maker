...
| RF-82 | **Cada columna dice cuántas obras tiene**, y una vacía lo dice en vez de quedarse en blanco. Sin ninguna obra, el taller dice que no hay ninguna y ofrece encargar la primera. Un filtro por texto sobre el título, la época y el destinatario reparte solo las tarjetas que casan, sin volver a pedir nada | `prueba` |

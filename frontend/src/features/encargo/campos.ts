...
export const GRUPOS: { titulo: string; campos: Campo[] }[] = [
  {
    ...
    campos: [
      ...
      { ruta: "tesis_tematica", etiqueta: "Qué sostiene la obra", clase: "largo" },
      { ruta: "elenco_declarado", etiqueta: "Personajes que fijas", clase: "lista" },
      { ruta: "capitulos_objetivo", etiqueta: "Cuántos capítulos", clase: "numero" },
      { ruta: "arcos", etiqueta: "Arcos", clase: "lista" },
    ],
  },
  {
    titulo: "El destinatario",
    campos: [
      ...
      { ruta: "destinatario.rasgos", etiqueta: "Cómo es", clase: "lista" },
      { ruta: "destinatario.recuerdos", etiqueta: "Recuerdos", clase: "lista" },
      { ruta: "destinatario.vetos", etiqueta: "Palabras o temas vetados", clase: "lista" },
    ],
  },
];

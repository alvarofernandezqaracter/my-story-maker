...
Traducción al castellano de la hoja de referencia externa que originó esta
skill. Es material de consulta: cada fila da el nombre del método, qué
...
| Revisión humana en el bucle | Una persona aprueba, rechaza o edita las acciones de consecuencia alta | El editor lee el resultado; dentro del ciclo de producción no hay pasos manuales | [Human-in-the-loop](https://en.wikipedia.org/wiki/Human-in-the-loop) |
